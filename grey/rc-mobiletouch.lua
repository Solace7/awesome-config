...
env:init({ theme = "mobiletouch", fm = "doublecmd", terminal = "urxvt"  })
...
-- Reload awesome widget/button
local reloadwidget = wibox.container.background(wibox.container.margin(wibox.widget {wibox.widget.textbox('reload WM'), layout=wibox.layout.fixed.horizontal}, 1, 1), beautiful.color.background)
reloadwidget:buttons(gears.table.join(
    reloadwidget:buttons(),
    awful.button({}, 1, nil, function()
	awesome.restart()	
    end)
))

-- Rofi prompt toggle/button
local rofiwidget = wibox.container.background(wibox.container.margin(wibox.widget {wibox.widget.textbox('prompt'), layout=wibox.layout.fixed.horizontal}, 1, 1), "#98971a")
rofiwidget:buttons(gears.table.join(
    rofiwidget:buttons(),
        awful.button({}, 1, nil, function()
...
local termwidget = wibox.container.background(wibox.container.margin(wibox.widget {wibox.widget.textbox('term'), layout=wibox.layout.fixed.horizontal}, 1, 1), beautiful.color.background)
termwidget:buttons(gears.table.join(
    termwidget:buttons(),
        awful.button({}, 1, nil, function()
...
local sysmenu = awful.menu({items = {{ "options", sysmenuopts }}})
local sysmenuwidget = wibox.container.background(wibox.container.margin(wibox.widget {wibox.widget.textbox('menu'), layout=wibox.layout.fixed.horizontal}, 1, 1), "#3f3f3f")
sysmenuwidget:buttons(gears.table.join(
		awful.button({ }, 1, function() sysmenu:toggle() end)
		))
...
local taglist = wibox.container.background(wibox.container.margin(wibox.widget {s.mytaglist, layout=wibox.layout.fixed.horizontal}, 1, 1), "#2f2f2f")
    ...
    s.bottompanel = awful.wibar({ position = "bottom", screen = s, height=beautiful.panel_height*2 })
    ...
    s.toppanel:setup {
        ...
        { -- Middle Widgets
        layout = wibox.layout.align.horizontal,
            arrow_l("alpha",beautiful.color.background),
            mytextclock,
    ...
    s.bottompanel:setup {
        ...
        { -- Right Widgets
            layout = wibox.layout.fixed.horizontal,
            s.layoutbox,
            arrow_r(beautiful.color.alt_background,beautiful.color.background),
	    reloadwidget,
            arrow_r(beautiful.color.background,"#98971a"),
	    rofiwidget,
            arrow_r("#98971a",beautiful.color.background),
	    termwidget,
            arrow_r(beautiful.color.background,"#3f3f3f"),
	    sysmenuwidget,
            arrow_r("#3f3f3f",beautiful.color.alt_background),
